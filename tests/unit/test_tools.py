...
@pytest.mark.parametrize(
    ...
    [
        ...
        (tools.web_browser_open, ("https://example.com",), {}),
        (tools.web_browser_observe, (), {}),
        (tools.web_browser_act, ("fill",), {"target": "@e1", "value": "hello"}),
        (tools.web_browser_close, (), {}),
        (tools.web_browser_screenshot, (), {}),
        (tools.web_browser_mouse, ("click",), {"x": 10, "y": 20}),
        (tools.web_browser_tabs, (), {}),
        (tools.web_browser_dialog, ("accept",), {}),
        (tools.web_browser_upload, ("e2", "download-123"), {}),
        (tools.web_browser_download, ("e1", True), {}),
